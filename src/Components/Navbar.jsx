        ...
        <div className="navbar-end">
          ...
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className=" lg:mr-2 md:mr-1  text-blue-600 underline hover:bg-[#79D7D0] hover:py-1 hover:px-3 hover:mr-0 hover:rounded-xl hover:text-white hover:no-underline"
              >
                Login
              </Link>
              <Link
